...
var HERO_GREETINGS = [ // from = 起始小时（升序），命中最后一个 from <= 当前小时 的时段；句子含标点 ≤10 字（hero 标题单行容量，真机 12 字实测折行）
  { from: 0,  name: '午夜', lines: ['该睡了哦~', '夜深人静，早点休息吧', '月亮都困了，该睡了'] },
  { from: 4,  name: '黎明', lines: ['熬穿了吗？注意身体', '天亮了，喝口水吧', '通宵虽爽，别贪杯哦'] },
  { from: 6,  name: '早上', lines: ['精神满满的一天开始了', '早安！新的一天开始了', '早上好，元气满格~'] },
  { from: 11, name: '中午', lines: ['现在适合放松一下呢', '午饭时间到，犒劳自己', '中午好，充充电吧'] },
  { from: 13, name: '下午', lines: ['努力的一天~继续加油', '下午时光，效率拉满', '保持节奏，稳稳前进'] },
  { from: 18, name: '傍晚', lines: ['晚霞正好，歇一会儿吧', '夕阳西下，辛苦一天啦', '傍晚的风，适合散步'] },
  { from: 20, name: '晚上', lines: ['精神满满自由时刻', '夜晚时光，做喜欢的事', '夜猫子模式，启动~'] }
];
var HERO_SUBS = [
  '应用、壁纸、AI，都在等你哦',
  '今天想折腾点什么好呢',
